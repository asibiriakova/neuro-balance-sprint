...
def register(body: RegisterRequest, store: InMemoryStore = Depends(get_store)) -> TokenResponse:
...
def login(body: LoginRequest, store: InMemoryStore = Depends(get_store)) -> TokenResponse:
